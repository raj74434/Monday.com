...
let navbar = () => {
    ...
    <div id="logo"><a href="../Homepage/index.html">
    ...
    <div id="left_menu">
        ...
        <div id="products" class="left_subdiv">   <div class="nav_menu12"><p class="left_title"> Products </p><img class="menu_arrow" id="arrow1" src="https://tse2.mm.bing.net/th?id=OIP.Vv5508glZF0pEPWYCku0iAHaHa&pid=Api&P=0"></img> </div>

            <div id="drop_down1">
          
            </div>
        </div>
        <div id="use_cases" class="left_subdiv"> <div class="nav_menu12"><p class="left_title">  Use cases </p><img class="menu_arrow" id="arrow2" src="https://tse2.mm.bing.net/th?id=OIP.Vv5508glZF0pEPWYCku0iAHaHa&pid=Api&P=0"></img> </div> 
        ...
        <div id="features" class="left_subdiv"> <div class="nav_menu12"><p class="left_title">   Features   </p><img class="menu_arrow" id="arrow3" src="https://tse2.mm.bing.net/th?id=OIP.Vv5508glZF0pEPWYCku0iAHaHa&pid=Api&P=0"></img> </div> 
            
            <div id="drop_down3">
          
            </div>
        </div>
        <div id="resources" class="left_subdiv"> <div class="nav_menu12"><p class="left_title">  Resources    </p><img class="menu_arrow" id="arrow4" src="https://tse2.mm.bing.net/th?id=OIP.Vv5508glZF0pEPWYCku0iAHaHa&pid=Api&P=0"></img> </div>  
    ...
    <div id="right_menu">
        <div><a href="/price_page/pricing.html"> <p class="right_title">  Pricing </p> </a></div>
...
let displayMenu = () => {
    ...
    if (i % 2 !== 0) {
        ...
        document.querySelector("#arrow1").style.transform="rotate(270deg)";   
        document.querySelector("#arrow4").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow2").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow3").style.transform="rotate(90deg)";
...
let usecasesfun = () => {
    ...
    if (j % 2 !== 0) {
        ...
        k=0;
        l=0;
        document.querySelector("#arrow2").style.transform="rotate(270deg)";  
        document.querySelector("#arrow1").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow4").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow3").style.transform="rotate(90deg)";
...
let featuresFun = () => {
    ...
    if (l % 2 !== 0) {
        ...
        k=0;
        i=0;
        document.querySelector("#arrow3").style.transform="rotate(270deg)"; 
        document.querySelector("#arrow1").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow2").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow4").style.transform="rotate(90deg)"; 
        document.querySelector("#drop_down1").innerHTML =null;
...
let resourcesFun = () => {
    ...
    if (k % 2 !== 0) {
        ...
        i=0;
        l=0;
        document.querySelector("#arrow4").style.transform="rotate(270deg)"; 
        document.querySelector("#arrow1").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow2").style.transform="rotate(90deg)"; 
        document.querySelector("#arrow3").style.transform="rotate(90deg)";  
        document.querySelector("#drop_down1").innerHTML =null;
