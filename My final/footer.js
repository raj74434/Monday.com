let footer = () => {
    ...
    <div id="foot1">
    <div>
        <svg id="footer_logo" width="127" height="42" viewBox="0 0 127 23"
            xmlns="http://www.w3.org/2000/svg">
            <title>Logo / monday.com</title>
            <g id="Page-1" fill="none" fill-rule="evenodd">
                <g id="Logo-/-monday.com-Copy">
                    <g id="Logo-/-monday.com">
                        <g id="Group" transform="translate(0 5.552)" fill-rule="nonzero">
                            <path
                            ...
                            <path
                                ...
                                id="Shape" fill="#FC0"></path>
                            <ellipse id="Shape" fill="#00CA72" cx="18.631" cy="10.31" rx="2.43" ry="2.379">
                            </ellipse>
                        </g>
                        <path
                            ...
                            id="com" fill="#333" fill-rule="nonzero"></path>
                        <path
...
<div id="external_links">
    <div id="external_links1">
        <div id="lang_set">
            <div>
                <svg id="globesvg" width="20" height="20" viewBox="0 0 20 20" fill="none"
                ...
                <svg width="15" height="15" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="Page-1" fill="none" fill-rule="evenodd">
                        <g id="change-copy" fill="#000" fill-rule="nonzero">
                            <path
            ...
            <div>
                <img src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/remote_mondaycom_static/img/footer/iso-logo1.png"
                    alt="">
                <img src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/remote_mondaycom_static/img/footer/gdpr-logo.png"
                    alt="">
                <img src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/remote_mondaycom_static/img/footer/soc-logo.png"
                    alt="">
                <img src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/remote_mondaycom_static/img/footer/hipaa-logo.png"
                    alt="">
            </div>
        </div>
        <div>
